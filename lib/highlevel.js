...
export async function createSubAccount({ name, email, phone, plan, businessName }) {
  ...
  const companyId = process.env.GHL_COMPANY_ID || 'kBxNIbpRIN7ggoYAK7Fg';
  ...
  // ── Step 3: Auto-provision Retell agent for Rocket/Velocity plans ──────────
  ...
  return {
    ...
    dashboardUrl: 'https://app.thehypeboxllc.com',
    retellAgentId,
  };
}
